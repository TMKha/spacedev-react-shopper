      ...
      <section>
        ...
        <div className="row">
          <div className="accordion_wrap col-md-8 offset-md-2 col-sm-12">
            ...
            <Accordion.Group>
            <Accordion title='Spacedev là gì?' >   I'd like to demonstrate a powerful little pattern called “Server-Fetched Partials” that
                offers
                some tangible benefits over alternatives like VueJS for simple page interactions.</Accordion>
            <Accordion title='Thành viên sáng lập Spacedev gồm những ai?'>   I'd like to demonstrate a powerful little pattern called “Server-Fetched Partials” that
                offers
                some tangible benefits over alternatives like VueJS for simple page interactions.</Accordion>
